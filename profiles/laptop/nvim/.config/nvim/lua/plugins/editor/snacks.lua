return {
	...
	keys = {
		...
		-- Other
		{ "<c-`>",      function() Snacks.terminal.toggle(nil, { interactive = false, }) 			end, desc = "Toggle Terminal" },
		{ "<c-/>",      function() Snacks.terminal.open(nil, { interactive = false }) 			end, desc = "Open Terminal" },
